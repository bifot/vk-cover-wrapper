...
module.exports = (groupId, groupToken, coverPath) => {
  return new Promise((resolve, reject) => {
    return getUploadServer(groupId, groupToken)
      .then(uploadServer => uploadCoverPhoto(uploadServer, coverPath))
      .then(coverData => saveCoverPhoto(Object.assign({}, coverData, { access_token: groupToken })))
      .then(resolve)
      .catch(reject)
  })
}
